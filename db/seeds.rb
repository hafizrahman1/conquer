...
PlanJob.create(plan_id: planC.id, job_id: job19.id)
PlanJob.create(plan_id: planC.id, job_id: job20.id)
...
PlanJob.create(plan_id: planC.id, job_id: job26.id)
PlanJob.create(plan_id: planC.id, job_id: job27.id)
PlanJob.create(plan_id: planC.id, job_id: job28.id)
